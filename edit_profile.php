							...
							<form action="" method="post">
								<div class="form-group">
									<div class="row">
										...
										<div class="col-2">
											<label>M.I.</label>
											<input type="text" class="form-control" name="middle_initial" value="<?php echo $row['middle_initial']; ?>" required>
										</div>
									</div>
								</div>
								<br>
								...
								<div class="form-group">
									<label>Address</label>
									<!-- <input type="text" class="form-control" name="address_information" value="<?php echo $row['address_information']; ?>" required> -->
									<textarea name="address_information" cols="30" rows="2" class="form-control" required><?php echo $row['address_information']; ?></textarea>
								</div>
							<?php
						} ?>
							<br />
